...
int main(int argc, char *argv[])
{
   ...
   ko = 2.0 * M_PI;
    ...
    ofstream out_file;
    out_file.open("test/demcem_ref_ss_ea_nxrwg.txt");
    for(int i = 0; i < 9; i++)
    {
    ...
    out_file.open("test/demcem_ref_ss_ea_rwg.txt");
    for(int i = 0; i < 9; i++)
    {
        out_file << real(I_DE[i]) << " " << imag(I_DE[i]) << "\n";
    }
    ...
    out_file.open("test/demcem_ref_ss_va_nxrwg.txt");
    for(int i = 0; i < 9; i++)
    {
        out_file << real(I_DE[i]) << " " << imag(I_DE[i]) << "\n";
    }
    ...
    out_file.open("test/demcem_ref_ss_va_rwg.txt");
    for(int i = 0; i < 9; i++)
    {
        out_file << real(I_DE[i]) << " " << imag(I_DE[i]) << "\n";
    }
   ...
   ko = 1.0;
    ...
    out_file.open("test/demcem_ref_ws_ea_rwg.txt");
    for(int i = 0; i < 9; i++)
    {
        out_file << real(I_DE[i]) << " " << imag(I_DE[i]) << "\n";
    }
   ...
   ko = 2.0 * M_PI;
    ...
    out_file.open("test/demcem_ref_ws_st_rwg.txt");
    for(int i = 0; i < 9; i++)
    {
        out_file << real(I_DE[i]) << " " << imag(I_DE[i]) << "\n";
    }
   ...
   ko = 2.0 * M_PI;
    ...
    out_file.open("test/demcem_ref_ws_va_rwg.txt");
    for(int i = 0; i < 9; i++)
    {
        out_file << real(I_DE[i]) << " " << imag(I_DE[i]) << "\n";
    }
