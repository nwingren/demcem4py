"""
Test script for DEMCEM bindings. Do not run here, instead run "pytest test" from parent directory.
...
def test_run_examples():
    ...
    compl = subprocess.run(['test/build/demcem_example_runner'], check=False)
...
def test_ss_ea_nxrwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ss_ea_nxrwg.txt')
...
def test_ss_ea_rwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ss_ea_rwg.txt')
    refvals = refvals[:,0] + 1j * refvals[:,1]
...
def test_ss_va_nxrwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ss_va_nxrwg.txt')
    refvals = refvals[:,0] + 1j * refvals[:,1]
...
def test_ss_va_rwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ss_va_rwg.txt')
    refvals = refvals[:,0] + 1j * refvals[:,1]
...
def test_ws_ea_rwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ws_ea_rwg.txt')
    refvals = refvals[:,0] + 1j * refvals[:,1]
...
def test_ws_st_rwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ws_st_rwg.txt')
    refvals = refvals[:,0] + 1j * refvals[:,1]
...
def test_ws_va_rwg():
    ...
    refvals = np.loadtxt('test/demcem_ref_ws_va_rwg.txt')
    refvals = refvals[:,0] + 1j * refvals[:,1]
